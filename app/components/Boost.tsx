    ...
    return(
        <>
            <section className="pt-40 w-9/12 mx-auto h-screen">
                <h2 className="text-6xl font-medium leading-tight text-center">Comment un site performant booste votre <br/> chiffre d&apos;affaires</h2>
                <div className="flex flex-wrap pt-44 items-center">
                    <div className="w-1/2">
                        <div className="relative bg-[#D9D9D9] bg-opacity-5 w-10/12 mx-auto rounded-3xl border">
                    ...
                    <div className="w-1/2">
                    <div className="w-10/12 mx-auto bg-[#D9D9D9] relative bg-opacity-5 rounded-3xl border">
