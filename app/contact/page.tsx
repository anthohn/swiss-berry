                ...
                <div className="w-full lg:w-1/2 flex flex-col space-y-20  p-4 lg:p-0">
                    <div className="flex flex-wrap justify-center">
                        ...
                        <div className="flex-grow ml-4 flex flex-col space-y-5 basis-[80%]">
                            ...
                            <p className="text-[16px] md:text-[20px] leading-6 text-neutral-400 text-justify">Veuillez remplir le formulaire de contact avec vos coordonnées. De cette façon, nous pouvons préparer pour vous et votre entreprise avant l’entretien.</p>
                        </div>
                    </div>
                    <div className="flex flex-wrap justify-center">
                        ...
                        <div className="flex-grow ml-4 flex flex-col space-y-5 basis-[80%]">
                            ...
                            <p className="text-[16px] md:text-[20px] leading-6 text-neutral-400 text-justify">Nous apprenons à nous connaître dès la première conversation. Nous examinons votre situation actuelle, vos objectifs et discutons de vos idées et de la portée de votre projet de site Web prévu. Enfin, vous recevrez une offre sans engagement.</p>
                        </div>
                    </div>
